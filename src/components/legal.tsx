...
const koreanTerms: LegalSection[] = [
  {title:'1. 목적 및 적용 범위',children:<p>본 약관은 Roundy의 이벤트 탐색, 프로필 설정, 참가 신청, 티켓, 이벤트 참여 및 이벤트 후 상호 매칭 서비스 이용에 적용됩니다. 서비스를 이용하면 본 약관 및 <Link href="/privacy">개인정보 처리방침</Link>에 동의한 것으로 봅니다.</p>},
  ...
  {title:'3. 참가 신청 및 확정 좌석',children:<p>참가 신청만으로 좌석이 확보되지는 않습니다. Roundy는 각 이벤트의 균형을 고려하여 신청을 검토하며, 승인 및 해당하는 경우 유효한 티켓 또는 결제가 확인된 때에만 좌석이 확정됩니다. 정원이 찬 경우 대기 명단을 운영할 수 있습니다.</p>},
...
const koreanPrivacy: LegalSection[] = [
  ...
  {title:'2. 수집하는 정보',children:<p>로그인을 위한 카카오 계정 식별자, 닉네임, 프로필 이미지와 함께 법적 이름, 생년월일, 성별, 국적, 사진, 키, 직장 또는 학교 정보, 관심사, 전화번호 등의 프로필 정보를 수집합니다. 또한 본인 확인을 위해 제출한 공개 소셜 계정 링크, 신청·티켓·출석·선택·매칭·신고·지원 기록을 수집합니다. 서비스 운영과 안전을 위해 필요한 정보만 수집합니다.</p>},
  ...
  {title:'7. 이용자의 권리',children:<p>열람, 정정, 삭제, 처리 제한 또는 동의 철회를 요청할 수 있습니다. 동의 철회는 프로필 확인, 참가 신청, 매칭처럼 해당 정보가 필요한 서비스 이용을 제한할 수 있습니다. 로그인 후 <Link href="/me/safety">안전 및 신고</Link>에서도 도움을 요청할 수 있습니다.</p>},
