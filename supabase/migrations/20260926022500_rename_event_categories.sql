...
set theme=case theme
  when '1:1 Speed Meetup' then '1:1 Speed Mingle'
  when 'Business Meetup' then 'Business Talk'
  else theme
end
where theme in ('1:1 Speed Meetup','Business Meetup');

alter table public.events
  add constraint events_theme_check
  check(theme in('1:1 Speed Mingle','Business Talk'));
